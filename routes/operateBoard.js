 ...
 *   /operate:
 *    post:
 *      summary: "운영게시판 게시글 데이터 생성"
 *      description: "운영게시판 게시글 데이터 생성"
 *      tags: [Operate Board]
 *      parameters :
 *         - in : headers
 *           name : authorization
 ...
 *   /operate:
 *    get:
 *      summary:  "운영게시판 게시글 데이터 전체 조회"
 *      description: "운영게시판 게시글 데이터 전체 조회"
 *      tags: [Operate Board]
 *      responses:
 *        "200":
 ...
 *   /operate/{id}:
 *    get:
 *      summary:  "운영게시판 특정 게시글 데이터 조회"
 *      description: "운영게시판 특정 게시글 데이터 조회"
 *      tags: [Operate Board]
 *      parameters :
 *        - in : path
 *          name : id
 *          required : true
 *          description : 운영게시판 게시글 아이디
 *          schema :
 *             type : uuid
 *      responses:
 *        "200":
 *          description: "운영게시판 특정 게시글 데이터"
 *          content:
 *            application/json:
 *              schema:
 *                type: object
 ...
 *   /operate/{id}:
 *    patch:
 *      summary:  "운영게시판 특정 게시글 데이터 수정"
 *      description: "운영게시판 특정 게시글 데이터 수정"
 *      tags: [Operate Board]
 *      parameters :
 *         - in : headers
 *           name : authorization
 ...
 *      responses:
 *        "200":
 *          description: "운영게시판 id 게시글 데이터 수정 성공"
 *          content:
 *            application/json:
 *              schema:
 *                type: object
 ...
 *   /operate/{id}:
 *    delete:
 *      summary:  "운영게시판 특정 게시글 데이터 삭제"
 *      description: "운영게시판 특정 게시글 데이터 삭제"
 *      tags: [Operate Board]
 *      parameters :
 *         - in : headers
 *           name : authorization
 ...
 *      responses:
 *        "200":
 *          description: "운영게시판 id 게시글 데이터 삭제"
 *          content:
 *            application/json:
 *              schema:
 *                  type : object
